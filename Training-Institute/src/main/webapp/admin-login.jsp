											...
											<form class="form" action="acceptAdmin" method="POST">
												...
												<div class="form-outline mb-4">
													<input type="text" id="adminID" name="adminID"
														...
														class="form-label" for="adminID">Admin ID</label>
												</div>

												<div class="form-outline mb-4">
													<input type="password" id="adminPassword"
														name="adminPassword" class="form-control form-control-lg" />
													<label class="form-label" for="adminPassword">Admin
														Password</label>
												</div>

												<input type="submit"
													class="btn btn-block btn-danger btn-large"
													value="ADMIN LOGIN">

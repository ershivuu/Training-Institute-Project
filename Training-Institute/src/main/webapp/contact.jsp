			...
			<div class="row">
				...
				<div class="col-lg-8">
					<form class="form-area contact-form text-right"
						action="insertmessage" method="post">
						<div class="row">
							<div class="col-lg-6 form-group">
								...
								<input type="text" name="email"
									...
									type="email"> <input type="text" name="subject"
							...
							<div class="col-lg-12">
								...
								<input type="Submit" class="genric-btn primary"
									style="float: right;" onclick="Success();" value="Send Message">
							</div>
						</div>
					</form>
				</div>

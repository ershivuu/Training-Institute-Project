				...
				<nav id="nav-menu-container">
                    ...
                    <ul>
                      ...
                      <li><a href="response-table.html">Approve Request</a></li>
						...
						<li><a href="viewstudentrequests/${INSTOBJ.instituteID}">Enrollment
								Requests</a></li>
		...
		<div class="container">
			<div
				...
				<div class="banner-content col-lg-9 col-md-12"
					...
					<h1 class="text-uppercase">Welcome to the Institute Portal</h1>
					<br>
					<br>
					<p class="pt-12 pb-12">Training institutes help the employee to
						increase job security and job satisfaction. The more satisfied the
						employee is, the greater are their morale and the more they will
						contribute to a company’s success.</p>
				</div>
			</div>
		</div>
	</section>

...
public class InstituteController {
	...
	/*
	 * @RequestMapping(value = "/viewNewStudentRequests/{instituteID}" , method =
	 * RequestMethod.GET) public String viewNewStudentRequests(Model
	 * m, @PathVariable int instituteID) {
	 * 
	...
	public String approveStudentRequest(Model m, HttpServletRequest request) {
		...
		daoImpl.updateStudentWithInstitute(userID, instituteID);

		List<Request> lst = daoImpl.getAllRequests(courseID);
		m.addAttribute("lst", lst);

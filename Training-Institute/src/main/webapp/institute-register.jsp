						...
						<div class="row g-0">
							...
							<div class="col-xl-6">
								<div class="card-body p-md-5 text-black">
									<h3 class="mb-5 text-uppercase">Institute Registration
										Form</h3>
									...
									<form id="registration_form" action="registerInstitute"
										...
										<div class="form-outline mb-4">
											<label class="form-label" for="instituteName">Institute
												Name</label> <input type="text" id="instituteName"
												name="instituteName" class="form-control form-control-lg"
												required /> <span class="error_form"
										...
										<div class="form-outline mb-4">
											<div class="form-outline">
												<label>Password</label> <input type="password"
													id="form_password" name="institutePassword"
													class="form-control form-control-lg" required=""> <span
													class="error_form" id="password_error_message"
													for="institutePassword"></span>
										...
										<div class="form-outline mb-4">
											<div class="form-outline">
												<label>Re-Enter Password</label> <input type="password"
													...
													class="form-control form-control-lg" name="" required="">
												<span class="error_form" id="retype_password_error_message"></span>
											</div>
										</div>

										<div class="form-outline mb-4">
											<label class="form-label" for="affiliationDate">Affiliation
												Date</label> <input type="date" id="affiliationDate"
												name="affiliationDate" class="form-control form-control-lg" />
										</div>
										...
										<div class="form-outline mb-4">
											<div class="form-outline ">
												<label class="form-label" for="seats">Total No. of
													seats</label> <input type="number" id="form_seats" name="seats"
													class="form-control form-control-lg" required /> <span
		...
		$(function() {
			...
			function check_sname() {
				...
				if (pattern.test(fname) && fname !== '') {
					$("#name_error_message").hide();
					$("#instituteName").css("border-bottom",
							"2px solid #34F458");
				} else {
			...
			function check_retype_password() {
				...
				if (password !== retype_password) {
					...
					$("#form_retype_password").css("border-bottom",
							"2px solid #F90A0A");

								...
								<div class="card-body p-md-5 text-black">
									...
									<form id="registration_form" action="registerStudent"
										...
										<div class="form-outline mb-4">
											<label class="form-label" for="userID">Student User
												ID</label> <input type="text" id="studentID" name="userID"
												class="form-control form-control-lg" required />
										</div>

										<div class="form-outline mb-4">
											<label class="form-label" for="emailID">Student Email
												ID</label> <input type="email" id="form_email" name="emailID"
										...
										<div class="form-outline mb-4">
											<label class="form-label" for="studentName">Student
												Name</label> <input type="text" id="studentName" name="studentName"
												class="form-control form-control-lg" required /> <span
										...
										<div class="form-outline mb-4">
											<label class="form-label select-label" for="qualification">Choose
										...
										<div class="form-outline mb-4">
											<div class="form-outline">
												<label>Password</label> <input type="password"
													id="form_password" name="studentPassword"
													class="form-control form-control-lg" required=""> <span
													class="error_form" id="password_error_message"
													for="studentPassword"></span>

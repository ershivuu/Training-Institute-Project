											...
											<form class="form" action="acceptInstitute" method="POST">
												...
												<div class="form-outline mb-4">
													<input type="number" id="instituteID" name="instituteID"
														...
														class="form-label" for="instituteID">Institute ID</label>
												</div>

												<div class="form-outline mb-4">
													<input type="password" id="institutePassword"
														name="institutePassword"
														class="form-control form-control-lg" /> <label
														class="form-label" for="institutePassword">Password</label>
												</div>

												<input type="Submit"
													class="btn btn-large btn-block btn-primary"
													value="LOGIN INSTITUTE"> <br> <a
													class="small text-muted" href="forgotPassword.jsp">Forgot
													password?</a>
												<p class="mb-5 pb-lg-2" style="color: #1e2bb9;">
													Don't have an account? <a href="institute-register.jsp"
														style="color: #1e2bb9;">Register here</a>
												<p></p>
												<p align="center">
